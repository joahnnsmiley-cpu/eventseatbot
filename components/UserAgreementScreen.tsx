    ...
    <div className="min-h-[100dvh] bg-[#0B0A09] text-white flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-5 py-6 space-y-5 text-sm text-white/80 leading-relaxed max-w-xl mx-auto w-full">
        ...
        <section className="space-y-2">
          ...
          <p>
            Организатор Сервиса не несёт ответственности за решения организатора в отношении
        ...
        <section className="space-y-2">
          ...
          <p>
            Сервис предоставляется «как есть». Организатор не гарантирует бесперебойную работу
            Сервиса и не несёт ответственности за технические сбои, прерывания доступа или
            потерю данных, возникшие по причинам, не зависящим от Организатора.
          </p>
          <p>
            Организатор не является стороной отношений между Пользователем и организатором
        ...
        <section className="space-y-2">
          ...
          <p>
            Организатор вправе вносить изменения в настоящее Соглашение. Актуальная версия
