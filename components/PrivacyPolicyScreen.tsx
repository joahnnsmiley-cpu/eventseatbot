      ...
      <div className="flex-1 overflow-y-auto px-5 py-6 space-y-5 text-sm text-white/80 leading-relaxed max-w-xl mx-auto w-full">
        ...
        <section className="space-y-2">
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>Идентификатор пользователя платформы (Telegram ID или VK ID) — получается автоматически при входе.</li>
        ...
        <section className="space-y-2">
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>Уведомления через Telegram-бот о статусе бронирования.</li>
          </ul>
        </section>
        ...
        <section className="space-y-2">
          ...
          <p>
            Данные хранятся в защищённой базе данных (Supabase / PostgreSQL, серверы расположены в ЕС). Данные
            хранятся на протяжении работы сервиса. Данные не передаются третьим лицам, за исключением
            уведомлений организатору мероприятия через Telegram-бот.
          </p>
        </section>
