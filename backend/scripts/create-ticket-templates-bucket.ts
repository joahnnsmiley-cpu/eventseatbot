/**
 * Create Supabase storage bucket "ticket-templates" if it does not exist.
 * - Public read access for ticket template images
 *
 * Run from backend: npx ts-node scripts/create-ticket-templates-bucket.ts
 * Requires: SUPABASE_URL, SUPABASE_SERVICE_ROLE_KEY
 */
import 'dotenv/config';
import { createClient } from '@supabase/supabase-js';

const BUCKET_NAME = 'ticket-templates';
